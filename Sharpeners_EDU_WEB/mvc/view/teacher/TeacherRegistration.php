...
<head>
    ...
    <title>Teacher Application Form | Sharpeners</title>
...
<body>
    <div class="heading">
        <h1 id="title">TEACHER APPLICATION FORM</h1>
        <p id="data">Please fill out this form with the right information</p>
    </div>
    <div class="ApplicationForm">
        ...
        <form id="reg-form" method="post" action="../../controller/Teacher/ApplicantsTeacherCheck.php" autocomplete="off"
            onsubmit="return TeacherReg()" enctype="multipart/form-data">
            <fieldset>
                ...
                <div class="input-email">
                    <label id="email-label">Email<input type="email" id="email" name="email" placeholder="Enter Your Email"
                            onkeyup="UniqueEmail()"></label>
                    <p class="err" id="email-p"></p>
                </div>
                <div class="input-address">
                    <label id="address-label">Address<input type="text" id="address" name="address"
                ...
                <div class="input-postcode">
                    <label id="postalcode-label">Postal Code<input type="number" id="postalcode" name="postalcode"
                            placeholder="Enter Your Postal Code"></label>
                    <p class="err" id="postalcode-p"></p>
                </div>
                <div class="input-contnum">
                    <label id="contnum-label">Contact Number<input type="tel" id="contnum" name="contnum"
                ...
                <div class="input-post">
                    <label id="post-label">Apply as
                        <label><input type="radio" id="post-teacher" name="post" value="Teacher" class="inline" /> Teacher </label>
                        <label><input type="radio" id="post-assist-teacher" name="post" value="Assistant Teacher"
                                class="inline" /> Assistant Teacher </label>
                    </label>
                ...
                <div class="input-qualification">
                    <label id="qualification-label">Educational Qualifications<textarea id="qualification" name="qualification"
                            placeholder="Enter Your Educational Qualifications"></textarea></label>
                    <p class="err" id="qualification-p"></p>
                </div>
                <div class="input-specialization">
                    <label id="specialization-label">Subject Specialization<input type="text" id="specialization"
                            name="specialization" placeholder="Enter Your Subject Specialization"></label>
                    <p class="err" id="specialization-p"></p>
                </div>
                <div class="input-experience">
                    <label id="experience-label">Teaching Experience (in years)<input type="number" id="experience"
                            name="experience" placeholder="Enter Your Teaching Experience"></label>
                    <p class="err" id="experience-p"></p>
                </div>
        ...
        <div class="checkstatus">
            ...
            <a href="TeacherApplicationStatus.php" id="checkstatus">Check Status Here</a>
            <br>
        </div>
        <div class="back">
