                                ...
                                <fieldset>
                                    ...
                                    <label for="division-up">Division
                                        <select name="divisionup" id="division-up">
                                            ...
                                            <option value="Dhaka" <?php if ($division == "Dhaka") {
                                                                        echo "selected";
                                                                    } ?>>Dhaka</option>
                                            <option value="Chittagong" <?php if ($division == "Chittogong") {
                                                                            echo "selected";
                                                                        } ?>>Chittagong</option>
                                            <option value="Sylhet" <?php if ($division == "Sylhet") {
                                                                        echo "selected";
                                                                    } ?>>Sylhet</option>
                                            <option value="Rangpur" <?php if ($division == "Rangpur") {
                                                                        echo "selected";
                                                                    } ?>>Rangpur</option>
                                            <option value="Khulna" <?php if ($division == "Khulna") {
                                                                        echo "selected";
                                                                    } ?>>Khulna</option>
                                            <option value="Barishal" <?php if ($division == "Barishal") {
                                                                            echo "selected";
                                                                        } ?>>Barishal</option>
                                            <option value="Rajshahi" <?php if ($division == "Rajshahi") {
                                                                            echo "selected";
                                                                        } ?>>Rajshahi</option>
                                            <option value="Mymensingh" <?php if ($division == "Mymensingh") {
                                                                            echo "selected";
                                                                        } ?>>Mymensingh</option>
                                        </select>
                                    </label>
                            ...
                            <form id="admin-update-form" method="post" action="../../controller/Admin/AdminUpdateCheck.php" autocomplete="off" onsubmit="return AdminAddressUp()" enctype="multipart/form-data">
                                <fieldset>
                                    ...
                                    <label for="gender-up">Gender
                                        <label><input type="radio" id="gender-male-up" name="genderup" value="Male" class="inline" <?php if ($gender == "Male") {
                                                                                                                                        echo "checked";
                                                                                                                                    } ?>> Male </label>
                                        <label><input type="radio" id="gender-female-up" name="genderup" value="Female" class="inline" <?php if ($gender == "Female") {
                                                                                                                                            echo "checked";
                                                                                                                                        } ?>> Female </label>
                                        <label><input type="radio" id="gender-others-up" name="genderup" value="Other" class="inline" <?php if ($gender == "Other") {
                                                                                                                                            echo "checked";
                                                                                                                                        } ?>> Other </label>
                                    </label>
