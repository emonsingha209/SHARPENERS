...
if (isset($_COOKIE['status'])) {
    $result = teacherApplicantsGetResult();
?>
    <!DOCTYPE html>
    ...
    <head>
        ...
        <title> Applicants For Teacher | Admin </title>
    ...
    <body>
        <div class="container">
            <h1 id="title">Applicants For Teacher Post</h1>
            <h1 id="<?php if (mysqli_num_rows($result) == 0) {
                        echo "no-data-show";
                    } else {
                        echo "no-data-hide";
                    } ?>">No Applicants Right Now</h1>
            <div class="Applicants">
                ...
                <?php while ($row = mysqli_fetch_assoc($result)) { ?>
                    <div class="ApplicantsData">
                        ...
                        <a href="../../controller/admin/TeacherAssign.php?email=<?php echo $row['Email'] ?>">Assign</a>
                        <a href="../../controller/admin/TeacherReject.php?email=<?php echo $row['Email'] ?>">Reject</a>
                    </div>
                <?php } ?>
            </div>
            <footer>
